...
GIT_SOURCE_URL=https://github.com/densho/ddr-public-assets
...
DEB_VERSION_BULLSEYE=$(APP_VERSION)~deb8
...
help:
	@echo "ddr-public-assets Install Helper"
...
deb-buster:
	...
	--chdir $(INSTALLDIR)   \
	assets=var/www/ddrpublic   \
	static=var/www/ddrpublic   \
	.git=$(DEB_BASE)   \
	.gitignore=$(DEB_BASE)   \
	assets=$(DEB_BASE)   \
	INSTALL=$(DEB_BASE)   \
